...
### Tag: schema-2017-10-preview

These settings apply only when `--tag=schema-2017-10-preview` is specified on the command line.
...
These can be regenerated by running the following PowerShell script from this readme file's folder: `dir .\Microsoft.Sql\2017-10-01-preview\ -File | Resolve-Path -Relative | % { " - $_".Replace("\", "/") }`

``` yaml $(tag) == 'schema-2017-10-preview'
input-file:
 - ./Microsoft.Sql/preview/2017-10-01-preview/databases.json
